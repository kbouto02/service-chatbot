...
class CoverageInSchema(Schema):
    ...
    crosssps = String(required=True, validate=Length(0, 255))
    ...
    ptscloudplat = String(required=True, validate=Length(0,255))
    zsw = String(required=True, validate=Length(0,255))
    csm = String(required=True, validate=Length(0,255))
